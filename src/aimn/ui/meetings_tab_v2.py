...
class MeetingsTabV2(QWidget):
    ...
    def _apply_workspace_labels(self) -> None:
        labels = {
            ...
            "status.add_plugin": self._tr("workspace.status.add_plugin", "Add plugin"),
            ...
            "search.back_to_text": self._tr("workspace.search.back_to_text", "Back to text"),
